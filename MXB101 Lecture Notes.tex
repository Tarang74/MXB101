...
\begin{definition}[Conditional probability]
    ...
    \begin{equation*}
        \Pr{\left( A \;\middle|\; B \right)} = \frac{\Pr{\left( A B \right)}}{\Pr{\left( B \right)}}.
    \end{equation*}
\end{definition}
\begin{definition}[Multiplication rule]
    For events \(A\) and \(B\), the general multiplication rule states that
    \begin{equation*}
        \Pr{\left( A B \right)} = \Pr{\left( A \;\middle|\; B \right)} \Pr{\left( B \right)}
    \end{equation*}
\end{definition}
\begin{theorem}[Independent events]
    If \(A\) and \(B\) are independent events then
    \begin{align*}
        \Pr{\left( A \;\middle|\; B \right)} & = \Pr{\left( A \right)} \\
        \Pr{\left( B \;\middle|\; A \right)} & = \Pr{\left( B \right)}
    \end{align*}
\end{theorem}
\begin{theorem}[Complement of independent events]
    ...
    \begin{align*}
        \Pr{\left( A \;\middle|\; \overline{B} \right)}            & = \Pr{\left( A \right)}            & \Pr{\left( B \;\middle|\; \overline{A} \right)}            & = \Pr{\left( B \right)}            \\
        \Pr{\left( \overline{A} \;\middle|\; B \right)}            & = \Pr{\left( \overline{A} \right)} & \Pr{\left( \overline{B} \;\middle|\; A \right)}            & = \Pr{\left( \overline{B} \right)} \\
        \Pr{\left( \overline{A} \;\middle|\; \overline{B} \right)} & = \Pr{\left( \overline{A} \right)} & \Pr{\left( \overline{B} \;\middle|\; \overline{A} \right)} & = \Pr{\left( \overline{B} \right)}
    \end{align*}
\end{theorem}
...
\begin{theorem}[Complement rule with condition]
    \begin{equation*}
        \Pr{\left( \overline{A} \;\middle|\; C \right)} = 1 - \Pr{\left( A \;\middle|\; C \right)}
    \end{equation*}
\end{theorem}
\begin{theorem}[Addition rule with condition]
    \begin{equation*}
        \Pr{\left( A \cup B \;\middle|\; C \right)} = \Pr{\left( A \;\middle|\; C \right)} + \Pr{\left( B \;\middle|\; C \right)} - \Pr{\left( AB \;\middle|\; C \right)}
    \end{equation*}
\end{theorem}
\begin{theorem}[Multiplication rule with condition]
    \begin{equation*}
        \Pr{\left( A B \;\middle|\; C \right)} = \Pr{\left( A \;\middle|\; BC \right)} \Pr{\left( B \;\middle|\; C \right)}
    \end{equation*}
\end{theorem}
...
\begin{definition}[Conditional independence]
    ...
    \begin{equation*}
        \Pr{\left( A \;\middle|\; B \right)} \neq \Pr{\left( A \right)}
    \end{equation*}
    but they become independent when conditioned with another event \(C\), i.e.,
    \begin{equation*}
        \Pr{\left( A \;\middle|\; BC \right)} = \Pr{\left( A \;\middle|\; C \right)}
    \end{equation*}
    Here we say that \(A\) and \(B\) are \textbf{conditionally independent} given \(C\). Furthermore
    \begin{equation*}
        \Pr{\left( AB \;\middle|\; C \right)} = \Pr{\left( A \;\middle|\; C \right)} \Pr{\left( B \;\middle|\; C \right)}
    \end{equation*}
    Conversely, events \(A\) and \(B\) may be conditionally dependent but unconditionally independent, i.e.,
    \begin{align*}
        \Pr{\left( A \;\middle|\; B \right)}  & = \Pr{\left( A \right)}                                                      \\
        \Pr{\left( A \;\middle|\; BC \right)} & \neq \Pr{\left( A \;\middle|\; C \right)}                                    \\
        \Pr{\left( AB \;\middle|\; C \right)} & = \Pr{\left( A \;\middle|\; BC \right)} \Pr{\left( B \;\middle|\; C \right)}
    \end{align*}
\end{definition}
\begin{theorem}
...
\begin{theorem}[Probability of subsets]
    ...
    \begin{equation*}
        \Pr{\left( B \;\middle|\; A \right)} = 1
    \end{equation*}
    Given \(\Pr{\left( AB \right)} = \Pr{\left( A \right)}\)
    \begin{equation*}
        \Pr{\left( A \;\middle|\; B \right)} = \frac{\Pr{\left( A \right)}}{\Pr{\left( B \right)}}
    \end{equation*}
...
\begin{theorem}[Total probability for complements]
    ...
    \begin{equation*}
        \Pr{\left( A \right)} = \Pr{\left( A \;\middle|\; B \right)}\Pr{\left( B \right)} + \Pr{\left( A \;\middle|\; \overline{B} \right)}\Pr{\left( \overline{B} \right)}
    \end{equation*}
\end{theorem}
